    ...
    <AdminSection title="💰 Oracle 價格測試" defaultExpanded={false}>
      <div className="space-y-6">
        ...
        <div className="bg-gray-800 rounded-lg p-4">
          ...
          <div className="flex gap-2 mb-2">
            <input
              ...
              className="flex-1 p-3 bg-gray-700 border border-gray-600 text-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400"
            />
            <div className="flex gap-1">
              {['0.1', '1', '10', '100'].map(amount => (
                <button
                  ...
                  className="px-3 py-2 text-sm bg-blue-900 text-blue-200 rounded hover:bg-blue-800 transition-colors"
                >
                  {amount}
                </button>
              ))}
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-4">
          <h4 className="font-semibold text-blue-400 mb-2">🔧 Oracle 配置</h4>
        ...
        <div className="bg-gray-800 border border-green-700 rounded-lg p-4">
          <h4 className="font-semibold text-green-400 mb-2">🧪 Oracle 基本功能測試</h4>
        ...
        <div className="bg-gray-800 border border-purple-700 rounded-lg p-4">
          <h4 className="font-semibold text-purple-400 mb-2">🔮 Oracle V22 自適應週期</h4>
              ...
              <div>
                ...
                <div className="mt-2 grid grid-cols-2 gap-2">
                  {(adaptivePeriods as number[] || []).map((period, index) => {
                    ...
                    return (
                      <div key={period} className="text-xs bg-gray-700 rounded p-2">
        ...
        <div className="bg-red-900 border border-red-700 rounded-lg p-2 mb-4">
          <p className="text-red-300 text-sm">🔥 調試：反向測試區塊應該在下方顯示</p>
          <p className="text-xs text-red-400">finalSoulShardAddress: {finalSoulShardAddress || 'undefined'}</p>
        </div>

        {/* ★ 新增：反向測試結果 (SoulShard → USD) */}
        <div className="bg-gray-800 border border-yellow-700 rounded-lg p-4">
          <h4 className="font-semibold text-yellow-400 mb-3">🔄 反向測試 (SoulShard → USD)</h4>
          ...
          {directReversePrice && coreReversePrice && (
            <div className="mt-3 p-2 bg-blue-900 rounded">
              <h6 className="font-medium text-blue-400 text-sm mb-1">🔍 反向一致性檢查</h6>
        ...
        <div className="bg-gray-800 border border-red-700 rounded-lg p-4">
          <h4 className="font-semibold text-red-400 mb-2">🚨 地址對比檢查</h4>
          <div className="text-sm space-y-2">
            <div>
              <span className="font-medium">Oracle 的 USD Token:</span>
              <code className="ml-2 text-xs bg-red-900 px-2 py-1 rounded text-red-300">
                {usdTokenAddress || '載入中...'}
              </code>
            </div>
            <div>
        ...
        {/* 重要說明：USD1 是 18 位精度 */}
        <div className="bg-gray-800 border border-blue-700 rounded-lg p-4">
          <h4 className="font-semibold text-blue-400 mb-2">💡 重要說明</h4>
        ...
        {/* 使用說明 */}
        <div className="bg-gray-800 border border-gray-600 rounded-lg p-4">
          <h4 className="font-semibold text-gray-300 mb-2">ℹ️ 說明</h4>
