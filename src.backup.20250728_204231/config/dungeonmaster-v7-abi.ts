// DungeonMaster V7 ABI - 最新版本 (2025-07-19)
// 來源: DungeonDelversContracts/artifacts/contracts/DungeonMaster_V7.sol/DungeonMasterV7.json

export const dungeonMasterV7ABI = [
  {
    "inputs": [
      {
  ...
  },
  {
    ...
    "name": "GlobalRewardMultiplierSet",
    "type": "event"
  },
  {
    "anonymous": false,
