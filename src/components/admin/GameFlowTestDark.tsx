// src/components/admin/GameFlowTestDark.tsx - 深色模式版本的完整遊戲流程測試面板
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gray-800 rounded-lg p-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h4 className="font-semibold text-gray-200">自動化測試套件</h4>
        ...
        {testResults.length > 0 && (
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-4">
            <h4 className="font-semibold text-gray-200 mb-3">測試進度</h4>
            ...
            return (
              <div
                ...
                className={`border rounded-lg p-4 transition-all duration-200 ${
                  ...
                  status === 'failed' ? 'border-red-600 bg-red-900/20' :
                  status === 'testing' ? 'border-blue-600 bg-blue-900/20' :
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 className="font-medium text-gray-200">{step.name}</h5>
        ...
        {testResults.length > 0 && (
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-4">
            <h4 className="font-semibold text-gray-200 mb-3">測試摘要</h4>
        ...
        <div className="bg-blue-900/20 border border-blue-600 rounded-lg p-4">
          <h4 className="font-semibold text-blue-400 mb-2">ℹ️ 測試說明</h4>
          <div className="text-sm text-blue-300 space-y-1">
            <p>• <strong className="text-blue-400">錢包連接</strong>: 檢查用戶錢包是否正確連接到 BSC 網路</p>
            <p>• <strong className="text-blue-400">合約配置</strong>: 驗證所有智能合約地址配置正確</p>
            <p>• <strong className="text-blue-400">NFT 頁面</strong>: 測試英雄、聖物、隊伍相關頁面載入</p>
            <p>• <strong className="text-blue-400">地城系統</strong>: 檢查地城探索數據和界面</p>
            <p>• <strong className="text-blue-400">VIP 系統</strong>: 驗證 VIP 質押功能運作</p>
            <p>• <strong className="text-blue-400">升級系統</strong>: 測試升星祭壇配置和連接</p>
            <p>• <strong className="text-blue-400">經濟系統</strong>: 檢查代幣餘額和獎勵機制</p>
            <p>• <strong className="text-blue-400">管理面板</strong>: 驗證所有管理功能正常</p>
          </div>
        </div>
      </div>
    </AdminSection>
