...
// 移除了 wagmi 的 hooks，因為我們現在是直接跳轉頁面
...
export const Footer: React.FC = () => {
  ...
  // 體驗服和正式服的網址 (您可以根據最終部署情況修改)
  const mainnetUrl = "https://www.soulshard.fun/";
  const testnetUrl = "https://test.soulshard.fun/"; // 推薦使用子網域
  ...
  return (
    <footer className="bg-[#1F1D36] text-gray-300 mt-auto">
      {/* 新的伺服器切換 UI */}
      <div className="bg-gray-800/50 text-white text-xs backdrop-blur-sm">
        <div className="container mx-auto px-4 py-2 flex justify-center items-center text-sm gap-2">
          <span className="text-gray-400">伺服器:</span>
          {/* 切換到正式服的按鈕 */}
          <button 
