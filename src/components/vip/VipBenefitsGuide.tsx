    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
          <h4 className="font-semibold text-blue-300 mb-3">📋 稅率計算公式</h4>
          <div className="bg-gray-800/50 p-3 rounded font-mono text-xs">
            <div className="text-yellow-300">// 合約中的實際計算邏輯</div>
            <div className="text-white mt-1">uint256 vipReduction = vipLevel * 50; // 50 BP = 0.5%</div>
            <div className="text-white">finalTaxRate = baseTaxRate - vipReduction;</div>
          </div>
          <p className="text-xs text-blue-200 mt-2">
            💡 50 個基點 (BP) = 0.5%，VIP 等級越高，享受的稅率減免越多
          </p>
        </div>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-purple-900/20 border border-purple-500/30 rounded-lg p-4">
          <h4 className="font-semibold text-purple-300 mb-3">⚜️ 加成機制</h4>
          <div className="space-y-2 text-sm">
            <div className="flex justify-between items-center">
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-orange-900/20 border border-orange-500/30 rounded-lg p-4">
          <h4 className="font-semibold text-orange-300 mb-3">🗡️ 探索加成</h4>
          <div className="space-y-2 text-sm">
            <div className="flex justify-between items-center">
              <span className="text-gray-300">加成類型</span>
        ...
        <div className="bg-gradient-to-r from-red-900/30 to-orange-900/30 border border-red-500/30 rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <div className="bg-gray-800/50 p-3 rounded">
                <div className="text-sm font-semibold text-blue-300 mb-2">🏔️ 新手礦洞 (地城1)</div>
                <div className="text-xs space-y-1">
                  <div className="flex justify-between">
                    <span className="text-gray-400">基礎成功率</span>
              ...
              <div className="bg-gray-800/50 p-3 rounded">
                <div className="text-sm font-semibold text-purple-300 mb-2">🕷️ 蜘蛛巢穴 (地城4)</div>
                <div className="text-xs space-y-1">
                  <div className="flex justify-between">
                    <span className="text-gray-400">基礎成功率</span>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-purple-900/20 border border-purple-500/30 rounded-lg p-4">
          <h4 className="font-semibold text-purple-300 mb-2">🖼️ NFT 特殊屬性</h4>
          <ul className="text-sm space-y-1 text-purple-200">
