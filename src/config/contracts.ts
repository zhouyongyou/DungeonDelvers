...
const CONTRACT_ADDRESSES = {
  ...
  // 遊戲合約 (3個) - 實際部署地址 (2025-01-17 V2)
  GAME: {
    DUNGEON_MASTER: import.meta.env.VITE_MAINNET_DUNGEONMASTER_ADDRESS || "0x5D4ae4275A5173A52EF32F42F21F13794dcFD95d",
