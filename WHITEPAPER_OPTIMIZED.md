...
1. **準備階段**: 使用 Soul Shard 購買補給
2. **派遣階段**: 選擇隊伍和目標地下城
3. **探索階段**: 鏈上隨機決定成功率
4. **結算階段**: 成功獲得獎勵，失敗損失補給
5. **恢復階段**: 24小時冷卻期，累積疲勞度
