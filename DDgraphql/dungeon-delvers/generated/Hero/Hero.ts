...
export class HeroMinted extends ethereum.Event {
  get params(): HeroMinted__Params {
    return new HeroMinted__Params(this);
  }
}

export class HeroMinted__Params {
  _event: HeroMinted;

  constructor(event: HeroMinted) {
    this._event = event;
  }
...
export class Hero__getHeroPropertiesResultValue0Struct extends ethereum.Tuple {
  get rarity(): i32 {
    return this[0].toI32();
  }
...
export class Hero__heroDataResult {
  value0: i32;
  value1: BigInt;
...
export class Hero extends ethereum.SmartContract {
  static bind(address: Address): Hero {
    return new Hero("Hero", address);
  }
  ...
  getHeroProperties(
    tokenId: BigInt,
  ): Hero__getHeroPropertiesResultValue0Struct {
    let result = super.call(
      "getHeroProperties",
      "getHeroProperties(uint256):((uint8,uint256))",
      [ethereum.Value.fromUnsignedBigInt(tokenId)],
    );

    return changetype<Hero__getHeroPropertiesResultValue0Struct>(
      result[0].toTuple(),
    );
  }

  try_getHeroProperties(
    tokenId: BigInt,
  ): ethereum.CallResult<Hero__getHeroPropertiesResultValue0Struct> {
    let result = super.tryCall(
      "getHeroProperties",
      "getHeroProperties(uint256):((uint8,uint256))",
      [ethereum.Value.fromUnsignedBigInt(tokenId)],
    ...
    return ethereum.CallResult.fromValue(
      changetype<Hero__getHeroPropertiesResultValue0Struct>(value[0].toTuple()),
    );
  }
  ...
  heroData(param0: BigInt): Hero__heroDataResult {
    let result = super.call("heroData", "heroData(uint256):(uint8,uint256)", [
      ethereum.Value.fromUnsignedBigInt(param0),
    ]);

    return new Hero__heroDataResult(result[0].toI32(), result[1].toBigInt());
  }

  try_heroData(param0: BigInt): ethereum.CallResult<Hero__heroDataResult> {
    let result = super.tryCall(
      "heroData",
      "heroData(uint256):(uint8,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Hero__heroDataResult(value[0].toI32(), value[1].toBigInt()),
    );
  }
